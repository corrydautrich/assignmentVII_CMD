...
let favoriteFoods = ["Donut Holes", "Chicken Tenders", "Mac and Cheese", "Grilled Cheese", "Chicken Alfredo", "Pickles"];

// 2. Loop through the list and print: "One of my favorite foods is ______."

for (let food of favoriteFoods) {console.log(`One of my favorite foods is ${food}.`);}
...
for (let i = 0; i < favoriteFoods.length; i++) {console.log(`My #${i +1} favorite food is ${favoriteFoods[i]}.`)};
...
function printFoodRecommendation(foodName) {console.log(`Have you ever tried ${foodName}?`); console.log(`I always recommend ${foodName} to friends.`); console.log(`Trust me - ${foodName} is delicious.`); console.log("");}

// 4b. Call the function at least 3 times

printFoodRecommendation("Chicken Alfredo"); printFoodRecommendation("Grilled Cheese"); printFoodRecommendation("Donut Holes");
...
if (longFoodNames.length > shortFoodNames.length) {console.log("There are more long-named foods.");} else if (shortFoodNames.length > longFoodNames.length) {console.log("There are more short-named foods.")} else {console.log("There are en equal number of long and short-named foods.");}
