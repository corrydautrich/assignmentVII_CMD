...
printFoodRecommendation("Chicken Alfredo"); 
printFoodRecommendation("Grilled Cheese"); 
printFoodRecommendation("Donut Holes");
...
if (longFoodNames.length > shortFoodNames.length) {
  ...
  console.log("There are en equal number of long and short-named foods.");
}
